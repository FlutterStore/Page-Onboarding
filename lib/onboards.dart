...
import 'package:pageonboarding/main.dart';
...
class _OnBoardingPageState extends State<OnBoardingPage> {
  ...
  Widget _buildImage(String assetName, double width,double height) {
    return Image.asset('assets/images/$assetName', width: width,height: height,fit: BoxFit.cover,);
  }
    ...
    return IntroductionScreen(
      ...
      pages: [
        PageViewModel(
          ...
          image: _buildImage('4.jpg',350,200),
        ...
        PageViewModel(
          ...
          image: _buildImage('3.jpg',350,200),
          decoration: pageDecoration,
        ),
        PageViewModel(
          title: "Another title page",
          body: "Another beautiful body text for this example onboarding",
          image: _buildImage('5.jpg',350,200),
          decoration: pageDecoration,
        ),
      ],
      onDone: (){
